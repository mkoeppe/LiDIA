...
#ifndef MATRIX
# if defined SPARSE
#  define MATRIX sparse_field_matrix
# elif defined DENSE
#  define MATRIX dense_field_matrix
# else
#  define MATRIX field_matrix
# endif
#endif
...
int main_LiDIA(int argc, char* argv[])
{
	...
	std::cout << "**********************************************************" << std::endl;
	std::cout << "***             Test for class field_matrix            ***" << std::endl;
	...
	std::cout << "the equality of {dense_, sparse_}field_matrix_appl_< type > .dat";
	std::cout << " and {dense_, sparse_}field_matrix_appl_< type > .out." << std::endl;
}
